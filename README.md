...
(1) Download the SBD dataset from [SBD website](http://home.bharathh.info/pubs/codes/SBD/download.html), and place the `tarball sbd.tar.gz` in `data_orig/`. Run the following command:
```
